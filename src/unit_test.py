...
class Test(unittest.TestCase):
    ...
    def test_AllLongestStrings1(self):
        self.assertEqual(
            f.allLongestStrings(["aba", "aa", "ad", "vcd", "aba"]),
            ["aba", "vcd", "aba"],
        )
    ...
    def test_AllLongestStrings3(self):
        self.assertEqual(
            f.allLongestStrings(["abc", "eeee", "abcd", "dcd"]), ["eeee", "abcd"]
        )
    ...
    def test_AllLongestStrings5(self):
        self.assertEqual(
            f.allLongestStrings(["enyky", "benyky", "yely", "varennyky"]), ["varennyky"]
        )

    def test_AllLongestString6(self):
        self.assertEqual(
            f.allLongestStrings(["abacaba", "abacab", "abac", "xxxxxx"]), ["abacaba"]
        )
    ...
    def test_AllLongestStrings8(self):
        self.assertEqual(
            f.allLongestStrings(["onsfnib", "aokbcwthc", "jrfcw"]), ["aokbcwthc"]
        )
